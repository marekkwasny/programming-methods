...
tests =
  ...
  , Test "fib"          (SrcFile   "fib.pp5")                                                  (Eval [] (Value 13))
  ...
  , Test "pair"         (SrcFile   "pair.pp5")                                                 (Eval [] (Value 71))
  , Test "pairmaker"    (SrcFile   "pairmaker.pp5")                                            (Eval [15] (Value 1))
  , Test "funit"        (SrcFile   "unit.pp5")                                                 (Eval [] (Value 1996))
  , Test "listlen"      (SrcFile   "intlist.pp5")                                              (Eval [] (Value 5))
  , Test "listcheck"    (SrcFile   "boollist.pp5")                                             (Eval [] (Value 0))
  , Test "pairsum"      (SrcFile   "pairsum.pp5")                                              (Eval [] (Value 7))
  , Test "listsum"      (SrcFile   "listsum.pp5")                                              (Eval [] (Value 32))  
  , Test "loop"         (SrcFile   "loop.pp5")                                                 (Eval [13] (Value 1))
  , Test "ifinarg"      (SrcFile   "convert.pp5")                                              (Eval [77] (Value 1))
  ]
