...
tests =
  ...
  , Test "fib"          (SrcFile   "fib.pp6")                                                  (Eval [] (Value 13))
  , Test "inttypefun"   (SrcString "fun function(u : unit) : int = True in function()")        TypeError
  , Test "booltypefun"  (SrcString "fun function(u : unit) : bool = 3 in function()")          TypeError
  , Test "pair"         (SrcFile   "pair.pp6")                                                 (Eval [] (Value 71))
  , Test "pairmaker"    (SrcFile   "pairmaker.pp6")                                            (Eval [15] (Value 1))
  , Test "funit"        (SrcFile   "unit.pp6")                                                 (Eval [] (Value 1996))
  , Test "listlen"      (SrcFile   "intlist.pp6")                                              (Eval [] (Value 5))
  , Test "listcheck"    (SrcFile   "boollist.pp6")                                             (Eval [] (Value 0))
  , Test "pairsum"      (SrcFile   "pairsum.pp6")                                              (Eval [] (Value 7))
  , Test "listsum"      (SrcFile   "listsum.pp6")                                              (Eval [] (Value 32))  
  , Test "loop"         (SrcFile   "loop.pp6")                                                 (Eval [13] (Value 1))
  , Test "ifinarg"      (SrcFile   "convert.pp6")                                              (Eval [77] (Value 1))
  , Test "lambdafun"    (SrcString "let x=22 in (fn(y:int)-> x div y) 2")                      (Eval [] (Value 11))
  , Test "badlambda"    (SrcString "let x=1 in (fn(y:int) -> x + y) ")                         TypeError
  , Test "zerolambda"   (SrcString "let x=0 in (fn(y:int) -> y mod x) 96")                     (Eval [] RuntimeError)
  , Test "addboollam"   (SrcString "let x=True in (fn(y:int) -> y - x) 13")                    TypeError
  ]
